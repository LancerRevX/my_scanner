...
from my_scanner.language.vulnerability import CRITICAL_LEVEL, HIGH_LEVEL, MEDIUM_LEVEL, LOW_LEVEL, INFO_LEVEL
from my_scanner.net.response import Response
...
class Attack:
    ...
    # DATA_DIR = resource_filename("wapitiCore", os.path.join("data", "attack"))
    ...
    def get_resource(resource_path: str):
        return resource_filename("wapitiCore", path_join("data", "attack", resource_path))
